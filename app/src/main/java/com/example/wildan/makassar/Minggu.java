...
public class Minggu extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_minggu, container, false);

        daftarschedule = new ArrayList<>();
        adapter = new AdapterSchedule(daftarschedule, Minggu.this.getContext());
        list = (ListView) v.findViewById(R.id.listminggu);
    ...
    void getAllSchedule() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Config.URL_MINGGU,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            Toast.makeText(Minggu.this.getContext(), "error : " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
//tempat response di dapatkan
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(Minggu.this.getContext(), "erroring: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                try {
                    ...
                    Toast.makeText(Minggu.this.getContext(), e.getMessage(), Toast.LENGTH_SHORT).show();
                    return params;
                }
            }
        };
